...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "G-Digital — умное управление личными финансами: счета, кредиты, долги и расходы в одном приложении." },
  ...
  return (
    <main className="gd-cosmos relative min-h-screen overflow-hidden font-sans text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[430px] flex-col items-center justify-center px-6">
        <div className="gd-fade-in flex flex-col items-center" style={{ animationDelay: "80ms" }}>
          <GLogo size={140} />
          <h1 className="mt-6 text-3xl font-semibold tracking-tight text-white/95 [text-shadow:0_0_24px_rgba(139,92,246,0.6)]">
            G-Digital
          </h1>
        </div>
        <div className="absolute bottom-16 w-64 gd-fade-in" style={{ animationDelay: "400ms" }}>
